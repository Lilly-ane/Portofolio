...
function Work({ position, company, location, type, duration }) {
  return (
    <article className="pt-8 pb-5 border-b-2 border-dark-content dark:border-light-content border-opacity-20 dark:border-opacity-20 last:border-b-0">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center">
        <div className="flex flex-col lg:flex-row lg:items-center mb-4 lg:mb-0">
          {/* Company Icon */}
          <div className="flex items-center pr-5 mb-2 lg:mb-0">
            <svg
              className="dark:fill-light-heading fill-dark-heading min-w-fit flex-shrink-0"
              width="20"
              height="16"
              viewBox="0 0 16 12"
              fill="none"
            ...
            <p className="text-content text-sm lg:text-base font-medium pl-2 truncate">{company}</p>
          </div>
          {/* Location Icon */}
          <div className="flex items-center">
            <svg
              className="dark:fill-light-heading fill-dark-heading min-w-fit flex-shrink-0 mr-2"
              width="20"
              height="16"
              viewBox="0 0 16 12"
              fill="none"
            ...
            <p className="text-content text-sm font-light">{location}</p>
          </div>
        </div>
        
        {/* Position & Duration */}
        <div className="flex flex-col items-start lg:items-end space-y-1">
          <h2 className="text-xl lg:text-2xl font-bold text-dark-heading dark:text-light-heading">{position}</h2>
          <p className="text-sm font-light text-dark-content dark:text-light-content">{duration}</p>
        </div>
      </div>
      
      {/* Type Badge */}
      <div className="mt-4">
        <span className="inline-block bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 text-xs font-medium px-3 py-1 rounded-full">
          {type}
        </span>
      </div>
    </article>
